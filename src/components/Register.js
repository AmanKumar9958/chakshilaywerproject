      ...
      <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg relative z-10">
        ...
        <div className="mt-4 md:mt-6 p-3 md:p-4 bg-[#b69d74]/10 border border-[#b69d74]/40 rounded-lg hover:bg-[#b69d74]/15 transition-all duration-300">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="text-xs md:text-sm font-semibold text-[#1f2839] mb-1">Secure Registration</h4>
              <p className="text-xs text-[#6b7280] leading-relaxed">
                Your account will be created securely. Fill in all fields and select your role to get started with Chakshi Legal Platform.
              </p>
            </div>
          </div>
        </div>
