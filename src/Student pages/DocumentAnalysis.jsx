  ...
  const Sidebar = () => {
    ...
    return (
      <div className="flex h-full flex-col gap-2 p-3" style={{ background: THEME.bg, borderRight: `1px solid ${THEME.border}` }}>
        ...
        <Item id="riskApi" label="Clause Risk Detector" icon={FileWarning} />
        <Item id="translate" label="Document Translator" icon={Languages} />
        <Item id="search" label="Smart Search Across Doc" icon={FileSearch2} />
        <Item id="compliance" label="Compliance Checklist Generator" icon={ShieldCheck} />
      </div>
    );
  };
